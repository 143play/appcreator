...
<form action="<?=base_url()?>create_app/templateSelection" method="post">
                ...
                {?>
                    <div class="col-md-2 text-center">
                        <label class="label-checkbox inline">
                            <input type="radio" checked value="<?=$template->id?>" name="template">
    ...
    <div class="panel-footer">
        <a href="<?=base_url()?>create_app/platformSelection" class="btn btn-success btn-sm enabled" id="prevStep" enabled>Previous</a>
